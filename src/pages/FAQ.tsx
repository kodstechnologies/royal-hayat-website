...
const FAQ = () => {
  ...
  const bodyTextClass = "font-body text-sm text-muted-foreground leading-relaxed text-justify";
  const getPageTitle = () => {
              ...
              {faqs.map((faq, i) => (
                <ScrollAnimationWrapper key={i} delay={i * 0.05}>
                  <div className="border border-border/50 rounded-xl overflow-hidden bg-popover">
                    ...
                    >
                      <span className={`${bodyTextClass} font-medium pr-4`}>{faq.q}</span>
                    ...
                    <div className={`overflow-hidden transition-all duration-300 ${openIndex === i ? "max-h-96 pb-5" : "max-h-0"}`}>
                      <p className={`px-6 ${bodyTextClass}`}>{faq.a}</p>
                    </div>
                  </div>
                </ScrollAnimationWrapper>
              ))}
        ...
        <section className="py-20 bg-background" id="disclaimer">
          <div className="container mx-auto px-6 max-w-3xl">
            <ScrollAnimationWrapper>
              ...
              <p className={bodyTextClass}>{t("disclaimerText")}</p>
            </ScrollAnimationWrapper>
          </div>
        </section>
      )}
        ...
        <section className="py-20 bg-background" id="terms">
          <div className="container mx-auto px-6 max-w-3xl">
            <ScrollAnimationWrapper>
              ...
              <div className={`${bodyTextClass} space-y-4`}>
                <p>{t("termsPrivacyIntro")}</p>
                <p className="font-bold">{t("termsPrivacySubtitle")}</p>
                {lang === "ar" ? (
