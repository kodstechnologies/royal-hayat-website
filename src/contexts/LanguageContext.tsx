...
const translations: Translations = {
  ...
  historyP1: { en: "Healthcare in Kuwait has long been known for its medical excellence. Yet, for many families, the experience of care often felt rushed, impersonal, and emotionally distant. Healing addressed the body but comfort, privacy, and hospitality were not always part of the journey", ar: "كانت الرعاية الصحية في الكويت تتطور، لكن العائلات — وخاصة النساء والأطفال — كانت تواجه واقعاً مألوفاً: الطب الممتاز غالباً ما يأتي بدون دفء أو خصوصية أو راحة. الرعاية كانت تشفي الجسد، لكنها في كثير من الأحيان تتجاهل تجربة المريض." },
