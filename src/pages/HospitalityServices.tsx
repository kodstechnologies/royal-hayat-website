          ...
          <ScrollAnimationWrapper>
            ...
            <div className="space-y-4 font-body text-sm text-muted-foreground leading-relaxed text-justify">
              {isAr ? (<>
                ...
                <p>وتضمن خدمات الضيافة الراقية في رويال حياة توفير مجموعة متكاملة من الخدمات، تشمل الضيافة، تنسيقات الزهور، وخيارات الترفيه، بما يتناسب مع احتياجات كل ضيف. كما يتوفر أيضًا مركز الرضاعة الطبيعية وتهيئة الولادة (Lamaze) في الدور السادس.</p>
              </>) : (<>
