...
export const departments: Department[] = [
  ...
  },
  {
    ...
    desc: "Level III Neonatal Unit — the highest in Kuwait's private sector — offering specialized care for premature and critically ill infants from 24 weeks of gestation.",
    descAr:
      "قسم العناية المركزة لحديثي الولادة من المستوى الثالث — الأعلى في القطاع الصحي الخاص بالكويت — يختص برعاية الأطفال الخدّج والحالات الحرجة ابتداءً من 24 أسبوعًا.",
  ...
  },
  {
    ...
    descAr: "تحكم في صحتك بسهولة من خلال برنامجنا المخصص. سجّل عن طريق إكمال نموذج تسجيل سريع، وتقديم لمحة عن تاريخك الطبي ونمط حياتك.",
