                ...
                {isAr ? (
                  <div className="font-body text-sm text-foreground leading-relaxed space-y-6 text-right">
                    ...
                    <div className="space-y-2 pt-2">
                      ...
                      <p>
                        <span className="font-semibold">الوقت:</span> من الساعة 10:00
                        صباحاً حتى 4:00 مساءً
                      </p>
                      <p>
                        <span className="font-semibold">المكان:</span> مستشفى رويال
                        حياة – الدور الأول، قاعة جاردينيا
                      </p>
                    </div>
                  </div>
                ) : (
                  <div className="font-body text-sm text-foreground leading-relaxed space-y-6 justified-body-en">
                    ...
                    <div className="space-y-3">
                      ...
                      <ul className="space-y-2 list-disc list-inside marker:text-foreground">
                        <li>
                          Candidates must have valid Kuwait MOH Nursing license.
                        </li>
                        <li>MOH license &amp; Visa must be transferable.</li>
                        <li>
                          All Candidates must have Bachelor Degree in Nursing.
                        </li>
                    ...
                    <div className="space-y-2 pt-2">
                      <p>
                        We invite you to join us at our Open Day and explore the
                      ...
                      <p>
                        <span className="font-semibold">Venue:</span> Royale Hayat
                        Hospital – 1st Floor, Gardenia Hall.
                      </p>
                    </div>
                  </div>
                )}
